# SpecProof Linux x64 Station Packages
...
Production releases use `specproof-station_<version>_amd64.deb`, which additionally contains
an offline dependency wheelhouse, Debian lifecycle scripts, a preserved configuration file,
and hardened systemd units. Build and verify it with `build_linux_deb.py`.
